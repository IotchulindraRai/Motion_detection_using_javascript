...
var MotionDetector=function(){
    function g(a){l=a;c.srcObject=a;c.play()
    }
    function m(a)
    {console.error(a)}
    function n(){if(l){
        ...
        h.height=c.offsetHeight;k.drawImage(c,0,0);
    ...
    a.data[b+2]=.5*(255-a.data[b+2])+.5*f[e].data[b+
2],a.data[b+3]=255,b+=4;p.putImageData(a,0,0)}}
var e=0,d=document.getElementById("canvas"),
h=document.getElementById("canvasFinal"),
c=document.getElementById("camStream"),
k=d.getContext("2d"),
p=h.getContext("2d"),
l=null,a=null,f=[];return{init:function(){
    navigator.getUserMedia?navigator.getUserMedia({
        video:!0},g,m):console.error("Your browser does not support getUserMedia");
